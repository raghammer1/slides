...
const Input = (0, _system.styled)('input')({
  flexGrow: 1,
  height: '40px',
...
const InputWithLabels = _ref => {
  ...
  return /*#__PURE__*/_react.default.createElement(Wrapper, null, /*#__PURE__*/_react.default.createElement(Label, null, label), /*#__PURE__*/_react.default.createElement(Input, {
    ...
    ,
    "data-testid": dataTestId ? dataTestId : "".concat(label, "-data")
  }));
};
var _default = exports.default = InputWithLabels;